...
module.exports = async (intentRequest, callback) => {
  ...
  if (source === 'FulfillmentCodeHook') {
    ...
    await saveOrderToDB({type: teaType, size: teaSize, price: cost, userId: intentRequest.userId});

    const {fulfillmentState, message} = buildFulfillmentResult('Fulfilled', `Your order of a ${teaType} is placed. Your total will be $${cost}. You can continue with your request or type 'close' to close the chat.`)
