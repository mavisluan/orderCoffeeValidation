...
module.exports = (intentRequest, callback) => {
  ...
  if (source === 'FulfillmentCodeHook') {
    ...
    const {fulfillmentState, message} = buildFulfillmentResult('Fulfilled', `Your order of a ${pizzaSize} ${pizzaCrust} ${pizzaType} is placed. Your total will be $${intentRequest.sessionAttributes['Price']}. You can continue with your request choose 'close' to close the chat.`)
